...
1 of 1,268
Movie pixel extraction demo
Inbox
x

Cory Inman <corysinman@g.ucla.edu>
Attachments
1:34 PM (37 minutes ago)
to me
...
Laboratory for Neuromodulation and Neuroimaging
...
Attachments area
Thanks!Thank you so much!Awesome, thanks!
...
ExtractMovieFrames.m
Displaying ExtractMovieFrames.m., folderName, FilterIndex] = uigetfile('*.avi');
		if ~isequal(baseFileName, 0)
			movieFullFileName = fullfile(folderName, baseFileName);
		else
			return;
...
ExtractMovieFrames.m
Displaying ExtractMovieFrames.m.