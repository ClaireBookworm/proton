# proton
<span style="color: #ffb400; font-weight: 600">Timing green flashes in video</span>
...
(If you don't have Python3, you can do `python oldPy.py` instead, this code if for python 2 but might not work as well...)

Frame processing is optimized to prevent clutter and from killing the VSCode IDE.
